...
namespace MudBlazorExampleExportTable.Client.Classes
{
    public class DataGridExporter
    {
        public static TableData GetTableData<T>(IEnumerable<Column<T>> columns, IEnumerable<T> items)
        {
        ...
        public static byte[] GenerateCSV(TableData data)
        {
        ...
        public static byte[] GenerateExcel(TableData data)
        {
